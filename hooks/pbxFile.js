...
function defaultExtension(fileRef) {
    // KC Chen: fix unknown error
    var filetype = ((fileRef.lastKnownFileType === 'unknown')?undefined:fileRef.lastKnownFileType) || fileRef.explicitFileType;
...
function pbxFile(filepath, opt) {
    ...
    this.basename = path.basename(filepath).replace(/[\"|\']/g,'');
    // console.log("> get basename... " + this.basename)
